...
class PretrainedBertModel:
    ...
    def load(cls, model_name: str, cache_model: bool = True) -> BertModel:
        ...
        return model
@TokenEmbedder.register("bert-pretrained-ours")
...
# This read s int eh Connl dataset 
...
class CoreferenceResolver(Model):
    ...
    def forward(self,  # type: ignore
        ...
        valid_antecedent_indices, valid_antecedent_offsets, valid_antecedent_log_mask = self._generate_valid_antecedents(num_spans_to_keep, max_antecedents, util.get_device_of(text_mask))
