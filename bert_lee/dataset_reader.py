...
class ConllCorefBertReader(DatasetReader):
    ...
    def __init__(self,
        ...
        self._token_indexers = {"tokens": PretrainedBertIndexer("bert-base-cased", do_lowercase=False)}
        self.token_indexer = PretrainedBertIndexer("bert-base-cased", do_lowercase=False)
    @overrides
